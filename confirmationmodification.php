...
<body>
    ...
    session_start();
          ...
          $nombase="elfi";
          $insertion="UPDATE `utilisateur` SET `nom_user` = '$nom', `prenom_user` = '$prenom', `mdp_user` = '$pwd', `datenaiss_user` = '$date', `adresse_user` = '$adresse', `imc_user` = '$imc', `sexe_user` = '$sexe' WHERE `utilisateur`.`email_user` = '$email'";
